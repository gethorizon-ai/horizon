...
class APIClient:
    ...
    def delete_user(self, api_key):
        ...
        response = requests.delete(
            f"{self.base_url}/api/users/", headers=headers)
        return response.json()
    ...
    def update_project(self, project_id, api_key, description=None, status=None, delete_evaluation_dataset=False):
        headers = {"Content-Type": "application/json", "X-Api-Key": api_key}
        data = {
    ...
    # Update a task
    def update_task(self, task_id, api_key, description=None, task_type=None,  evaluation_dataset=None, status=None):
        headers = {"Content-Type": "application/json", "X-Api-Key": api_key}
        payload = {
            "description": description,
            "task_type": task_type,
    ...
    def upload_evaluation_dataset(self, task_id, file_path, api_key):
        ...
        with open(file_path, 'rb') as f:
            response = requests.post(f"{self.base_url}/api/tasks/{task_id}/upload_evaluation_dataset", files={
                "evaluation_dataset": f}, headers=headers)
        return response.json()

    def view_evaluation_dataset(self, task_id, api_key):
        headers = {"X-Api-Key": api_key}
        response = requests.get(
            f"{self.base_url}/api/tasks/{task_id}/view_evaluation_dataset", headers=headers)
        return response.json()
    ...
    def delete_evaluation_dataset(self, task_id, api_key):
        headers = {"X-Api-Key": api_key}
        response = requests.delete(
            f"{self.base_url}/api/tasks/{task_id}/delete_evaluation_dataset", headers=headers)
        return response.json()
    ...
    def create_task(self, name, project_id, task_type, objective, file_path, api_key):
        ...
        with open(file_path, 'rb') as f:
            eval_response = requests.post(f"{self.base_url}/api/tasks/{task_id}/upload_evaluation_dataset", files={
                "evaluation_dataset": f}, headers=headers)
