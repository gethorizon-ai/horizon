...
register_response = horizon.register_user(
    "testuser_5", "testuser_5@example.com", "testpassword")
...
get_user_response = horizon.get_user(user_id, api_key)
print(get_user_response)

# Test project-related methods
project = horizon.create_project("Test Project", user_id, api_key)
print(project)
...
upload_response = horizon.upload_evaluation_datasets(
    project_id, "/Users/linatawfik/Documents/horizon/local_horizon_developer_rest_api/demo/data/email_gen_demo.csv", api_key)
print(upload_response)

view_datasets = horizon.view_evaluation_datasets(project_id, api_key)
print(view_datasets)


# Test tasks-related methods
task = horizon.create_task("Test Task", "classification", project_id, api_key)
print(task)
...
delete_datasets = horizon.delete_evaluation_datasets(project_id, api_key)
